...
htmlhelp_basename = 'QuantityValueDoc'
...
latex_documents = [
    (master_doc, 'Quantity-Value.tex', u'Quantity-Value Documentation',
...
man_pages = [
    (master_doc, 'QuantityValueDoc', u'Quantity-Value Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'QuantityValueDoc', u'Quantity-Value Documentation',
     author, 'QuantityValueDoc', 'On-line description of project',
     'Miscellaneous'),
]
